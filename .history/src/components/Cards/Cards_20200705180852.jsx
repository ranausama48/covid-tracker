    ...
    <Grid container spacing={3} justify="center">
      ...
      <Grid item component={Card}>
        <CardContent>
          ...
          <Typography varaint="h5">{props.data.confirmed.values}</Typography>
      ...
      <Grid item component={Card}>
        <CardContent>
          ...
          <Typography varaint="h5">{props.data.recoverd}</Typography>
          <Typography color="textSecondary">Real Date</Typography>
          <Typography varaint="body2">
      ...
      <Grid item component={Card}>
        <CardContent>
          ...
          <Typography varaint="h5">{props.data.deaths}</Typography>
          <Typography color="textSecondary">Real Date</Typography>
